export const IMAGE_BACKGROUND = require('../src/images/asset/backgroundLogin.jpeg');
export const IMAGE_GEOLOCATION = require('../src/images/asset/logoGeolocation.png');
